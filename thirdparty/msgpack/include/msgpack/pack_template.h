...
msgpack_pack_inline_func_cint(_unsigned_short)(msgpack_pack_user x,
                                               unsigned short d) {
#if defined(SIZEOF_SHORT)
#if SIZEOF_SHORT == 2
  msgpack_pack_real_uint16(x, d);
...
msgpack_pack_inline_func_cint(_unsigned_int)(msgpack_pack_user x,
                                             unsigned int d) {
#if defined(SIZEOF_INT)
#if SIZEOF_INT == 2
  msgpack_pack_real_uint16(x, d);
...
msgpack_pack_inline_func_cint(_unsigned_long_long)(msgpack_pack_user x,
...
msgpack_pack_inline_func(_str_body)(msgpack_pack_user x, const void *b,
                                    size_t l) {
...
msgpack_pack_inline_func(_v4raw_body)(msgpack_pack_user x, const void *b,
                                      size_t l) {
  msgpack_pack_append_buffer(x, (const unsigned char *)b, l);
}
...
msgpack_pack_inline_func(_bin_body)(msgpack_pack_user x, const void *b,
                                    size_t l) {
  msgpack_pack_append_buffer(x, (const unsigned char *)b, l);
}
...
msgpack_pack_inline_func(_ext_body)(msgpack_pack_user x, const void *b,
                                    size_t l) {
  msgpack_pack_append_buffer(x, (const unsigned char *)b, l);
}
