...
#define MSGPACK_COMP_MWERKS_DETECTION                                          \
  MSGPACK_VERSION_NUMBER(9, (__MWERKS__) % 100 - 1, 0)
#endif
#if !defined(MSGPACK_COMP_MWERKS_DETECTION) && (__MWERKS__ >= 0x3200)
#define MSGPACK_COMP_MWERKS_DETECTION                                          \
  MSGPACK_VERSION_NUMBER(9, (__MWERKS__) % 100, 0)
#endif
#if !defined(MSGPACK_COMP_MWERKS_DETECTION) && (__MWERKS__ >= 0x3000)
#define MSGPACK_COMP_MWERKS_DETECTION                                          \
  MSGPACK_VERSION_NUMBER(8, (__MWERKS__) % 100, 0)
#endif
#if !defined(MSGPACK_COMP_MWERKS_DETECTION)
...
#include <msgpack/predef/detail/test.h>
MSGPACK_PREDEF_DECLARE_TEST(MSGPACK_COMP_MWERKS_EMULATED,
