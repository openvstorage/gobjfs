...
static inline bool msgpack_zbuffer_init(msgpack_zbuffer *zbuf, int level,
                                        size_t init_size);
...
static inline int msgpack_zbuffer_write(void *data, const char *buf,
                                        size_t len);
...
static inline msgpack_zbuffer *msgpack_zbuffer_new(int level,
                                                   size_t init_size) {
