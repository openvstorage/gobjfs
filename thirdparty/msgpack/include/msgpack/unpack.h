 ...
 * The initialized deserializer must be destroyed by
...
/**
 * Destroys a streaming deserializer initialized by
 * msgpack_unpacker_init(msgpack_unpacker*, size_t).
 */
MSGPACK_DLLEXPORT
 ...
 * The created deserializer must be destroyed by
 * msgpack_unpacker_free(msgpack_unpacker*).
 */
MSGPACK_DLLEXPORT
 ...
 */
static inline bool msgpack_unpacker_reserve_buffer(msgpack_unpacker *mpac,
                                                   size_t size);
...
msgpack_unpacker_buffer_capacity(const msgpack_unpacker *mpac);
 ...
 */
static inline void msgpack_unpacker_buffer_consumed(msgpack_unpacker *mpac,
                                                    size_t size);
 ...
 * The initialized object must be destroyed by
 * msgpack_unpacked_destroy(msgpack_unpacker*).
 * Use the object with msgpack_unpacker_next(msgpack_unpacker*,
 * msgpack_unpacked*) or
 ...
 */
static inline msgpack_zone *
msgpack_unpacked_release_zone(msgpack_unpacked *result);
...
static inline size_t
msgpack_unpacker_message_size(const msgpack_unpacker *mpac);
...
static inline size_t
msgpack_unpacker_parsed_size(const msgpack_unpacker *mpac) {
  return mpac->parsed;
}
