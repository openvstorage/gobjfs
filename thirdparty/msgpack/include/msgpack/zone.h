...
static inline void *msgpack_zone_malloc_no_align(msgpack_zone *zone,
                                                 size_t size);
...
static inline void *msgpack_zone_malloc(msgpack_zone *zone, size_t size) {
  char *aligned =
      (char *)((size_t)(zone->chunk_list.ptr + (MSGPACK_ZONE_ALIGN - 1)) /
  ...
  {
    void *ptr =
        msgpack_zone_malloc_expand(zone, size + (MSGPACK_ZONE_ALIGN - 1));
    if (ptr) {
